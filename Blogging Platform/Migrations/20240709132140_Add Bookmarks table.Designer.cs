...
namespace Blogging_Platform.Migrations
{
    ...
    [Migration("20240709132140_Add Bookmarks table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogging_Platform.Models.Bookmark", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "33c8bcf8-05c4-494c-8435-310c0ecf3873",
                            Name = "admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "f18a21e0-15ef-4816-9e75-668d0450db6d",
                            Name = "user",
                            NormalizedName = "user"
                        });
                });
            ...
            modelBuilder.Entity("Blogging_Platform.Models.Bookmark", b =>
                {
                    ...
                    b.HasOne("Blogging_Platform.Models.AppUser", "User")
                        .WithMany("Bookmarks")
                        .HasForeignKey("UserId");
